...
module.exports.pitch = function(remainingRequest) {
	...
	return [
		...
		"var cssTransformation;",
		query.cssTransformation ? "cssTransformation = require('" + path.resolve(query.cssTransformation) + "');" : "",
		"var options = " + JSON.stringify(query),
		"options.cssTransformation = cssTransformation",
